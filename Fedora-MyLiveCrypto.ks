...
repo --name="bravebrowser" --baseurl=https://s3-us-west-2.amazonaws.com/brave-rpm-release/x86_64/
repo --name="localrepo" --baseurl=http://192.168.8.172/fedora/27/x86_64/mycrypto/
